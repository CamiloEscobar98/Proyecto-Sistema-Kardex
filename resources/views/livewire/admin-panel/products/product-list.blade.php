    ...
    <table class="w-full table-auto">
        <thead>
            <tr class="text-sm leading-normal text-gray-600 uppercase bg-gray-200 dark:bg-gray-600 dark:text-gray-100">
                ...
                <th class="px-6 py-3 text-left">@lang('models/product.attributes.price')</th>
                <th class="px-6 py-3 text-left">@lang('models/product.attributes.stock')</th>
        ...
        <tbody class="text-sm font-light text-gray-600 dark:text-gray-200 ">
            @forelse ($products as $item)
                <tr
                    ...
                    <td class="px-4 py-3 text-left">{{ $loop->iteration }}</td>
                    ...
                    <td class="px-6 py-3 text-left">{{ $item->price }}USD</td>
                    <td class="px-6 py-3 text-left">{{ $item->stock }}</td>
                    ...
                    <td class="w-fit">
                        <div class="grid grid-flow-col grid-rows-1 gap-1">
                            <a href="{{ route('admin_panel.products.show', $item) }}"
                                class="px-2 py-1 text-center text-white bg-indigo-600 rounded-l-3xl"><i
