    ...
    <table class="w-full table-auto">
        <thead>
            <tr class="text-sm leading-normal text-gray-600 uppercase bg-gray-200 dark:bg-gray-600 dark:text-gray-100">
                <th class="px-6 py-3 text-left">@lang('models/product_category.attributes.name')</th>
                ...
                <tr
                    ...
                    <td class="w-fit">
                        <div class="grid grid-flow-col grid-rows-1 gap-1">
                            <a href="{{ route('admin_panel.product_categories.show', $item) }}"
                                class="px-1 py-1 text-center text-white bg-indigo-600 rounded-l-3xl"><i
                                    class="fas fa-edit"></i></a>
                            @livewire('admin-panel.product-categories.product-category-delete', ['productCategory' => $item], key("product-delete-{$item->id}"))
                        </div>
                    </td>
                </tr>
            @empty
